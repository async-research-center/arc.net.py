...
DISPLAY_NAME="TERMINALUSER"

def authenticate():
    print("TERMINAL_11242")
    ...
    class LocalDatabase:
        ...
        self.docs[""]=SCPDocument("MANKIND IN ITS PRESENT STATE HAS BEE AROUND FOR A QUATRER OF A MILLION YEARS, YET ONLY A SMALL FRACTION OF THAT HAS BEEN OF ANY SIGNIFICANCE. SO, WHAT DID WE DO FOR NEARLY 250,000 YEARS? WE HUDDLED IN CAVES AND AROUND SMALL FIRES, FEARFUL OF THE THINGS THAT WE DIDN'T UNDERSTAND. IT WAS MORE THAN EXPLAINING WHY THE SUN CAME UP, IT WAS THE MYSTERY OF ENORMOUS BIRDS WITH HEADS OF MEN AND ROCKS THAT CAME TO LIFE. SO WE CALLED THEM GODS AND DEMONS, BEGGED THEM TO SPARE US, AND PRAYED FOR SALVATION. IN TIME, THEIR NUMBERS DWINDLED AND OURS ROSE. THE WORLD BEGAN TO MAKE MORE SENSE WHEN THERE WERE FEWER THINGS TO FEAR, YET THE UNEXPLIANED CAN NEVER TURLY GO AWAY, AS IF THE UNIVERSE DEMANDS THE ABSURD AND IMPOSSBILE. MANKIND MUST NOT GO BACK TO HIDING IN FEAR. NO ONE ELSE WILL PROTECT US, AND WE MUST STAND UP FOR OURSELVES WHILE THE REST OF MANKIND DWELLS IN THE LIGHT, WE MUST STAND IN THE DARKNESS TO FIGHT IT, CONTAIN IT, AND SHIELD IT FROM THE EYES OF THE PUBLIC, SO THAT OTHERS MAY LIVE IN A SANE AND NORMAL WORLD. WE SECURE. WE CONTAIN. WE PROTECT. - THE ADMINISTRATOR")
    def list_docs(self):
        print("\n ==DATABASE ACCESS==")
